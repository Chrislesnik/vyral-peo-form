...
const ReviewAndPaymentForm = React.forwardRef<HTMLFormElement, ReviewAndPaymentFormProps>(
  ({className, ...props}, ref) => {
    ...
    return (
      <>
        <div className="text-default-foreground text-3xl leading-9 font-bold">Review & Submit</div>
        <div className="text-default-500 py-4 text-base leading-5">
          You are almost done 🎉. After you submit, our AI agent will reach out with next steps.
        </div>
        <form
          ref={ref}
